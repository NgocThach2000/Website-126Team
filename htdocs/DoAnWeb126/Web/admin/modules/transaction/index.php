            ...
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-xs btn-primary" href="http://sporter.unaux.com/DoAnWeb126/Web/admin/modules/banner_slide_show/veiwTransaction.php?id=<?php echo $item['id'] ?>"> <i class="fa fa-info"></i> Chi tiết</a>
                            <a class="btn btn-xs btn-danger" href="http://sporter.unaux.com/DoAnWeb126/Web/admin/modules/banner_slide_show/deleteTransaction.php?id=<?php echo $item['id'] ?>"> <i class="fa fa-times"></i> Xóa</a>
                        </td>
                    </tr>
                    <?php $stt++; endforeach; ?>
                </tbody>
