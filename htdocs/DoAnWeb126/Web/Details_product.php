            ...
            <div class="page_container2"> 
                <div class="main_containt clearfix fixwidth" >
                    ...
                    <div class="main_containt_right " >
                        ...
                        <select id="sizeT">
                        <?php foreach($tachsize as $prosize => $size): ?>
                        <option> <?php echo $size ?> </option>
                        <?php endforeach ?>
                        </select>
                        </div>
                        <div class=cart_call>
                            <div class="cart1" ><a style="text-decoration: none;" href="Shoping_cart.php?id=<?php echo $product['id']?>&&<?php echo  $string  ?>"><img src="<?php echo public_frontend() ?>img/icons8-shopping-cart-100.png" width="30"></img></a></div>
                        ...
                        <!--Product Random-->
                            ...
                            <div class="Clothes_item2">
                                <div >
                                    <a href="Details_product.php?id=<?php echo $item['id'] ?>&&<?php echo  $string  ?>"><img src="<?php echo uploads_product() ?><?php echo $item['thunbar1'] ?>"  class="image"/></a>
                                </div>
                                ...
                                <div class="clothes_all2">
                                    ...
                                    <a class="clothes_info2" href="Details_product.php?id=<?php echo $item['id'] ?>&&<?php echo  $string  ?>" >Chi tiết</a>
                                </div>
                            </div>
                            <?php endforeach ?>   
                            <!--end Product Random-->
