...
<?php include_once __DIR__. "/layouts/header.php" ?>
    ...
    <title><?php echo $EditCategory['name']; ?></title>  
</head>
                    ...
                    <div class="Clothes_list">
                        ...
                        <div class="Clothes_item">
                            ...
                            <?php if($item['sale'] != 0) : ?>
                                ...
                                <div class=Big_img>
                                    <a href="Details_product.php?id=<?php echo $item['id'] ?>&&<?php echo  $string  ?>"><img src="<?php echo uploads() ?>product/<?php echo $item['thunbar1'] ?> " class="image"/></a>
                                    <span>SALE <?php echo $item['sale'] ?>%</span>
                                    <div class="image2">
                                        <a href="Shoping_cart.php?id=<?php echo $item['id']?>&&<?php echo  $string  ?>"><img src="<?php echo public_frontend() ?>img/icons8-shopping-cart-100.png" class="icon_image" ></a>
                                    </div>
                                </div>
                            ...
                            <?php else: ?>
                                ...
                                <?php endif?>
                                <a class="clothes_info" href="Details_product.php?id=<?php echo $item['id'] ?>&&<?php echo  $string  ?>" >Chi tiết</a>
                                </div>
    ...
    <script type="text/javascript" src="js/mmenu.js"></script>
        <script>
            ...
            $('.menu_sidebar >li').click(function(){
                if(!$(this).hasClass('sidebar_option')){
                    $(this).addClass('sidebar_option');
                }
                else{
                    $(this).removeClass('sidebar_option');
                }
                $(this).find('.ul_danhmuc').toggle();
            });
        </script>
