    ...
    <div class="page_container">
        ...
        <div class=big_menu_header>
            ...
            <div class="menu_header2 clearfix"> <!-- div con dùng float thì thêm class clearfix ở div cha -->            
                ...
                <form class="example" action="Search.php" method ="get"style="max-width:200px">
                <input type="text" placeholder="Tìm kiếm" name="search2">
                <button type="submit"><i class="fa fa-search"></i></button>
                </form>
                
                <?php $tmp = addslashes($_GET['search2']);?> 
...
<script>   
        $('.menu_sidebar >li').click(function(){
            if(!$(this).hasClass('ul_sidabar')){
                $(this).addClass('ul_sidabar');
            }
            else{
                $(this).removeClass('ul_sidabar');
            }
            $(this).find('ul').toggle();
        });
    </script>
