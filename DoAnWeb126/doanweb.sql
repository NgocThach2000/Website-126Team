...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 19, 2020 lúc 03:56 PM
...
(4, 'Hồ Phạm Ngọc Thạch', 1, 'ngocthach26112000@gmail.com', '0778889076', 'Tây Ninh', 'wp4382182.jpg', '123123123Thach', '2020-06-22 15:21:57', '2020-07-18 07:54:04'),
(7, 'Van Thang', 1, 'VanThang@gmail.com', '023065412', 'Bình Định', '', '123123123Thang', '2020-06-22 18:48:58', '2020-07-17 03:58:15'),
(16, 'Thủy Tiên', 2, 'Tien@gmail.com', '090956565', 'Tây Ninh', '42044308_2163746367285237_8367527505942282240_o.jpg', '123123123Tien', '2020-07-17 03:33:16', '2020-07-19 13:07:54'),
...
(19, 'Nguyễn Quang Trường', 1, 'QTruong@gmail.com', '0909090909', 'Bình Dương A', '', '123123123Truong', '2020-07-17 17:09:35', '2020-07-19 13:03:54');
...
--
ALTER TABLE `category`
  ADD CONSTRAINT `lienketbangcha` FOREIGN KEY (`category_parent_id`) REFERENCES `category_parent` (`id`);

--
-- Các ràng buộc cho bảng `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `lienkethoadon` FOREIGN KEY (`transaction_id`) REFERENCES `transaction` (`id`),
  ADD CONSTRAINT `lienketsanpham` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`);

--
-- Các ràng buộc cho bảng `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `lienketdanhmuc` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`);

--
-- Các ràng buộc cho bảng `transaction`
--
ALTER TABLE `transaction`
  ADD CONSTRAINT `lienketkhachmua` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
