...
//cập nhật thông tin người dùng
    ...
    if($_SERVER["REQUEST_METHOD"] == "REQUEST"){
        ...
        if(postInput('email') == ''){
        	...
        	{
        		$is_check_mail = $db1->fetchOne("user", " email = '" .$data1['email']."' ");
        ...
        if(postInput('phone') == ''){
        	...
        	{
	        	$is_check_phone = $db1->fetchOne("user", " phone = '" .$data1['phone']."' ");
        ...
        if(postInput('password') != NULL && postInput("re_password") != NULL)
        {
        	if(postInput('password') != postInput('re_password'))
        	{
                ...
                $data1['password'] = postInput("password");
            }
        }
...
<body> 
    <div class="main_containt clearfix fixwidth" >
        ...
        <div class="main_containt_right clearfix">
            <form method="POST" enctype="multipart/form-data1">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="phone" class="form-control" id="inputPassword4" min="0" max="99999999999"  value="<?php echo $Edituser['phone'] ?>">
                        <?php if(isset($error['re_password'])): ?>
