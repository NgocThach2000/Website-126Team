    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control col-sm-2 control-label" placeholder="********" id="igroups" name="password" value="<?php echo $data['password'] ?>" >
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control col-sm-2 control-label" placeholder="********" id="igroups" name="re_password" >
